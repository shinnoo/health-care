...
export class DiseaseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.diseaseService
      ...
      .subscribe(
        (res: HttpResponse<IDisease[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDiseases(): void {
    this.eventSubscriber = this.eventManager.subscribe('diseaseListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDisease[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
