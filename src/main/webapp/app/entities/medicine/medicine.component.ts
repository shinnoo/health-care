...
export class MedicineComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.medicineService
      ...
      .subscribe(
        (res: HttpResponse<IMedicine[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMedicines(): void {
    this.eventSubscriber = this.eventManager.subscribe('medicineListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMedicine[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
