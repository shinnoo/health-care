...
export class MedicalHistoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.medicalHistoryService
      ...
      .subscribe(
        (res: HttpResponse<IMedicalHistory[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMedicalHistories(): void {
    this.eventSubscriber = this.eventManager.subscribe('medicalHistoryListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMedicalHistory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
