...
public class NurseResource {
     ...
     */
    @PostMapping("/nurses")
    public ResponseEntity<NurseDTO> createNurse(@Valid @RequestBody NurseDTO nurseDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/nurses")
    public ResponseEntity<NurseDTO> updateNurse(@Valid @RequestBody NurseDTO nurseDTO) throws URISyntaxException {
