...
import { NurseComponent } from 'app/entities/nurse/nurse.component';
import { NurseService } from 'app/entities/nurse/nurse.service';
import { Nurse } from 'app/shared/model/nurse.model';

describe('Component Tests', () => {
  describe('Nurse Management Component', () => {
    let comp: NurseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NurseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.nurses && comp.nurses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
